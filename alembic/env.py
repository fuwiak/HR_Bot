...
from backend.database.models_sqlalchemy import Base, TelegramMessage, TelegramUser
...
# Загружаем конфигурацию базы данных из config.yaml
db_config = load_config("database")
db_settings = db_config.get("database", {}).get("postgresql", {})

# Формируем DATABASE_URL из конфига или переменных окружения
