...
// GET /tm/projects — список проектов (команда: weeek проекты). Только названия, без LLM.
// Эквивалент: curl -H "Authorization: Bearer $WEEEEK_TOKEN" https://api.weeek.net/public/v1/tm/projects
