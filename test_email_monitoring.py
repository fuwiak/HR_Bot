...
async def test_handle_email_reply():
    ...
    from app import handle_email_reply, email_cache
...
async def test_handle_email_proposal():
    ...
    from app import handle_email_proposal, email_cache
...
async def test_handle_email_task():
    ...
    from app import handle_email_task, email_cache
...
async def test_handle_email_create_task():
    ...
    from app import handle_email_create_task, email_cache
...
async def test_email_monitor_task():
    ...
    from app import email_monitor_task, processed_email_ids, send_email_notification
...
async def test_email_check_command():
    ...
    from app import email_check_command, processed_email_ids
