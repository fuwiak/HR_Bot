# HR2137_bot - AI-ассистент для консалтинговой практики

Интеллектуальный AI-ассистент для автоматизации работы консалтинговой практики с интеграцией RAG базы знаний, обработки лидов и управления проектами.
...
3. **Обновлены промпты**
   ...
   - Анастасия Новосёлова (HR-консультант)
...
- HR-консультант: Анастасия Новосёлова
...
5. ✅ Проверка графика работы HR-специалистов
